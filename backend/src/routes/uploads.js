...
const KINDS = {
  ...
  // Chat attachments (incl. the project chat) — private, images or PDF; served
  // via short-lived signed URLs by the conversation/message layer.
  chat:             { bucket: PRIVATE_BUCKET, folder: 'chat',           types: [...IMAGE_TYPES, ...DOC_TYPES] },
