...
function JobBoardPage({ setView, jobs, setJobs, pendingJobs, setPendingJobs, currentUser, refreshJobs, refreshProjects }) {
...
function MarketplacePage({ listings, setListings, pendingListings, setPendingListings, currentUser, refreshMarketplace }) {
  const isStudent = currentUser?.role === 'student';
